...
export function Environment(name: string): BaseURL {
  return `https://${name}-my-app-pcki.encr.app`;
}
...
/**
 * Client is an API client for the my-app-pcki Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "my-app-pcki-Generated-TS-Client (Encore/v1.31.0)",
    };
